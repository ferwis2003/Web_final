...
<body>
    ...
    <div class="col-md-12 search-table-col" style="margin-top: -44px;">
        <div class="form-group pull-right col-lg-4"><input type="text" class="search form-control" placeholder="Search by typing here.." style="margin-top: 14px;"></div><span class="counter pull-right"><a class="btn btn-primary" role="button" style="border-radius: 48px;font-size: 26px;background: rgb(28,119,252);font-family: 'Noto Sans Inscriptional Pahlavi', sans-serif;font-weight: bold;width: 63.75px;border-width: 0px;padding-top: 12px;" href="AGREGAR_vehiculos.php">+</a></span>
        <div class="table-responsive table table-hover table-bordered results">
            <table class="table table-hover table-bordered">
                <thead class="bill-header cs">
                    <tr>
                        <th id="trs-hd-1" class="col-lg-1" style="width: 436.344px;">ID</th>
                        <th id="trs-hd-1" class="col-lg-2" style="width: 436.344px;">Placa</th>
                        <th id="trs-hd-2" class="col-lg-3" style="width: 364.109px;">Marca</th>
                        <th id="trs-hd-3" class="col-lg-4" style="width: 558.953px;">Modelo</th>
                        <!--<th id="trs-hd-4" class="col-lg-2" style="width: 481.156px;">Foto</th>-->
                        <th id="trs-hd-7" class="col-lg-5" style="width: 94.016px;">Tipo</th>
                        <th id="trs-hd-6" class="col-lg-6" style="width: 236.484px;"><br><strong>Latitud</strong><br></th>
                        <th id="trs-hd-5" class="col-lg-7" style="width: 350.156px;"><br><strong>Longitud</strong><br></th>
                        <!--<th id="trs-hd-8" class="col-lg-2" style="width: 180.562px;">Asignado</th>-->
                        <th id="trs-hd-9" class="col-lg-8" style="width: 717.828px;">Comentario</th>
                        <th id="trs-hd-9" class="col-lg-8" style="width: 717.828px;"> </th>
                ...
                $mision = manejador_vehiculos::listaVehiculos(); 
                ...
                <tr> 
                    ...
                    <td>
                    <a class='btn btn-info' role='button' style='margin-left: 5px;' href='agregar_vehiculos.php?id={$misio->id}'><i class='fas fa-user-edit text-dark' style='font-size: 15px;'></i></a>
                    <a class='btn btn-success' onclick='eliminarFila(this)' role='button' style='margin-left: 5px;' ><i class='fas fa-trash-alt' style='font-size: 15px; color: black;'></i></a>
